...
class Search {
  constructor() {
    ...
    //search overlay
    this.result = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-overlay__result");
    ...
    this.isOpen = false;
    this.timing;
    this.searchItem = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term");
    this.event();
  ...
  getResults() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().getJSON(universityData.root_url + "/wp-json/university/v1/schools?term=" + this.searchItem.val(), results => {
      this.result.html(`
    <div class="row">
      <div class="one-third">
